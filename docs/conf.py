...
sys.path.insert(0, os.path.abspath('../source_codes/memoir/stats'))
...
latex_documents = [
    (master_doc, 'Memoir.tex', 'Memoir Documentation',
     'Shivam Chaudhary', 'manual'),
]
...
man_pages = [
    (master_doc, 'memoir', 'Memoir Documentation',
     [author], 1)
]
